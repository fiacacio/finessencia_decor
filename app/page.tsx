...
const products = [
  { name: 'Alecrim', image: '/essencias_clique/Alecrim.jfif' },
  { name: 'Capim Limão', image: '/essencias_clique/Capim limão.jfif' },
  { name: 'Flor de Figo', image: '/essencias_clique/Flor de Figo.jfif' },
  { name: 'Laranjeira', image: '/essencias_clique/Laranjeira.jfif' },
  { name: 'Lavanda', image: '/essencias_clique/Lavanda.jfif' },
  { name: 'Cereja e Avelã', image: '/essencias_clique/Cereja e Avelã.jfif' },
  { name: 'Daslu', image: '/essencias_clique/Daslu.jfif' },
  { name: 'Limão Siciliano', image: '/essencias_clique/Limão Siciliano.jfif' },
  { name: 'Maçã com Canela', image: '/essencias_clique/Maça com Canela.jfif' },
]
...
const productShowcase = [
  ...
  { name: 'Blends', image: '/essencias_clique/Cereja e Avelã.jfif' },
  { name: 'Escalda Pés', image: '/essencias_clique/Lavanda.jfif' },
  { name: 'Rechauds', image: '/essencias_clique/Velas.jfif' },
  { name: 'Sabonetes', image: '/velas-principal.jpg' },
]

const catalogProducts = [
  { name: 'Vela Aromática', detail: '120 g', description: 'Aroma acolhedor para momentos de pausa.', price: 'R$ 39,90', image: '/essencias_clique/Velas.jfif' },
  { name: 'Home Spray', detail: '250 ml', description: 'Perfuma seu espaço com leveza e frescor.', price: 'R$ 49,90', image: '/essencias_clique/Home Spray.jfif' },
  { name: 'Difusor de Ambientes', detail: '200 ml', description: 'Fragrância contínua para acolher o ambiente.', price: 'R$ 59,90', image: '/essencias_clique/Difusores.jfif' },
  { name: 'Blend Aromático', detail: '50 g', description: 'Mistura aromática para rituais sensoriais.', price: 'R$ 29,90', image: '/essencias_clique/Flor de Figo.jfif' },
  { name: 'Escalda-Pés', detail: '150 g', description: 'Cuidado e relaxamento em cada pausa.', price: 'R$ 34,90', image: '/essencias_clique/Lavanda.jfif' },
  { name: 'Sabonete Artesanal', detail: '100 g', description: 'Limpeza delicada e perfumada para a rotina.', price: 'R$ 22,90', image: '/velas-principal.jpg' },
]
...
export default function Page() {
  return <main className="site-shell">
    ...
    <section className="catalog" aria-labelledby="catalog-title"><p className="eyebrow">MOSTRUÁRIO</p><h2 id="catalog-title">ESCOLHA SEU PRODUTO</h2><div className="catalog-grid">{catalogProducts.map((product) => <article className="catalog-card" key={product.name}><div className="catalog-media"><img src={product.image} alt={product.name} /></div><div className="catalog-info"><h3>{product.name}</h3><p>{product.detail}</p><p className="catalog-description">{product.description}</p><div className="catalog-price"><strong>{product.price}</strong><a href={getWhatsAppUrl(product.name)} target="_blank" rel="noreferrer" aria-label={`Pedir ${product.name} pelo WhatsApp`}><FaWhatsapp /></a></div></div></article>)}</div></section>
    <section className="about" id="historia"><div className="about-copy"><p className="eyebrow">NOSSA ESSÊNCIA</p><h2>Feito para transformar ambientes em momentos.</h2><p>Na Finessência, cada criação une fragrâncias marcantes, beleza e delicadeza. São detalhes artesanais pensados para acolher a rotina e criar memórias afetivas.</p></div></section>
    <footer id="contato"><img src="/Logo PNG Branco.png" alt="Finessência decor aromático" /><a href={instagramUrl} target="_blank" rel="noreferrer">@finessenciadecor</a><span>Feito com delicadeza para o seu momento.</span></footer>
  </main>
}

...
const catalogProducts = [
  ...
  { name: 'Blend Aromático', detail: '50 g', description: 'Mistura aromática para rituais sensoriais.', price: 'R$ 29,90', image: '/essencias_clique/Blend Aromático.jfif' },
  { name: 'Escalda-Pés', detail: '150 g', description: 'Cuidado e relaxamento em cada pausa.', price: 'R$ 34,90', image: '/essencias_clique/Escalda pés.jfif' },
  { name: 'Sabonete Artesanal', detail: '100 g', description: 'Limpeza delicada e perfumada para a rotina.', price: 'R$ 22,90', image: '/essencias_clique/Sabonete Artesanal.jfif' },
]
